...
final class AppTests: XCTestCase {
    ...
    func testAdmin1TableCoversProductionTerritoriesAndSwitzerland() {
        ...
        XCTAssertEqual(Admin1.code(country: "Iceland", region: "Austurland"), "IS-7")
        XCTAssertEqual(Admin1.code(country: "Lithuania", region: "Alytaus"), "LT-AL")
        XCTAssertEqual(Admin1.code(country: "Latvia", region: "Aglonas"), "LV-001")
        XCTAssertEqual(Admin1.code(country: "Estonia", region: "Harju"), "EE-37")
        XCTAssertEqual(Admin1.code(country: "Bulgaria", region: "Blagoevgrad"), "BG-01")
        XCTAssertEqual(Admin1.code(country: "Romania", region: "Alba"), "RO-AB")
        XCTAssertEqual(Admin1.code(country: "Macedonia", region: "Aerodrom"), "MK-01")
        XCTAssertEqual(Admin1.code(country: "Republic of Serbia", region: "Borski"), "RS-14")
        XCTAssertEqual(Admin1.code(country: "San Marino", region: "Acquaviva"), "SM-01")
        XCTAssertEqual(Admin1.code(country: "Liechtenstein", region: "Balzers"), "LI-01")
        XCTAssertEqual(Admin1.code(country: "Luxembourg", region: "Diekirch"), "LU-D")
        XCTAssertEqual(Admin1.code(country: "Denmark", region: "Hovedstaden"), "DK-84")
        XCTAssertEqual(Admin1.code(country: "Slovakia", region: "Banskobystrický"), "SK-BC")
        XCTAssertEqual(Admin1.code(country: "Japan", region: "Aichi"), "JP-23")
        ...
        XCTAssertEqual(Admin1.code(country: "Italy", region: "Crotene"), "IT-78")
        XCTAssertEqual(Admin1.code(country: "Italy", region: "Oristrano"), "IT-88")
