...
enum PushCopy {
    ...
    static func prueba(lang: String?) -> (String, String) {
        switch (lang ?? "ca").prefix(2) {
        case "es": return ("FontApp", "Los avisos funcionan en este dispositivo.")
        case "gl": return ("FontApp", "Os avisos funcionan neste dispositivo.")
        ...
        case "pt": return ("FontApp", "Os avisos funcionam neste dispositivo.")
        case "it": return ("FontApp", "Le notifiche funzionano su questo dispositivo.")
        default:   return ("FontApp", "Els avisos funcionen en aquest dispositiu.")
        }
    }
