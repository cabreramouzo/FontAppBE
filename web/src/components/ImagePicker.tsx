  ...
  if (preview) {
    return (
      <div className="imgpick-preview">
        <img src={preview} alt={t('image.previewAlt')} />
        <button type="button" className="imgpick-remove" onClick={() => onChange(null)} aria-label={t('image.remove')}>✕</button>
      </div>
    )
  }
