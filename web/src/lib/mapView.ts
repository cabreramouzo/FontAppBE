...
const BY_ZONE: Record<string, View> = {
  ...
  'America/New_York': v(39.5, -98.5, 4), 'America/Chicago': v(39.5, -98.5, 4),
  'America/Denver': v(39.5, -98.5, 4), 'America/Phoenix': v(34.2, -111.7, 6),
  'America/Los_Angeles': v(39.5, -98.5, 4), 'America/Detroit': v(39.5, -98.5, 4),
  'America/Indiana/Indianapolis': v(39.5, -98.5, 4), 'America/Boise': v(39.5, -98.5, 4),
  'America/Anchorage': v(62, -150, 4), 'Pacific/Honolulu': v(20.8, -157.5, 7),
  'America/Toronto': v(50, -85, 4), 'America/Vancouver': v(53, -123, 5),
  'America/Edmonton': v(54, -114, 5), 'America/Winnipeg': v(52, -97, 5),
  'America/Regina': v(52, -106, 5), 'America/Halifax': v(45, -63, 6),
  'America/St_Johns': v(48.5, -56, 6), 'America/Moncton': v(46.5, -65.5, 7),
