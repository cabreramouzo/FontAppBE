...
Implementada el 23/09/2026: login/registro, fichas, localidades y GPX sin interrupciones; búsqueda manual accesible desde la primera bienvenida incluso tras denegar ubicación. La presentación automática se conserva con la historia original del Pirineo para explicar qué es FontApp a quien llega por primera vez sin sesión; aparece una vez y respeta las rutas sin interrupciones. Corrección del 24/09/2026 a petición del autor: reducir interrupciones no debe eliminar la historia que explica el origen del proyecto. Instalación tras un favorito guardado con éxito, con el descarte mensual existente. Validación: build web y tests de rutas e instalación. Pendientes cinco sesiones observadas y prueba física; despliegue por confirmar.
